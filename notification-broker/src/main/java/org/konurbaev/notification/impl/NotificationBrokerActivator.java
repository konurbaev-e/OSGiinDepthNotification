...
public class NotificationBrokerActivator implements BundleActivator,
    ...
    private void initializeSchema() {
        configurationSchema = new ObjectClassDefinition() {
            ...
            AttributeDefinition [] requiredAttrs =
                    new AttributeDefinition [] {
                            new AttributeDefinition() {
                                ...
                                public String getID() {
                                    return "org.konurbaev.notification.broker" + ".port";
                                }
            ...
            public AttributeDefinition[] getAttributeDefinitions(int filter) {
                return (filter == ObjectClassDefinition.ALL || filter == ObjectClassDefinition.REQUIRED) ? requiredAttrs : null;
            }
            ...
            public String getID() {
                return "org.konurbaev.notification.broker";
            }
    ...
    private void updateBrokerService(int port) {
        ...
        brokerRegistration = context.registerService(NotificationBroker.class.getName(), broker, serviceProperties);
    }
